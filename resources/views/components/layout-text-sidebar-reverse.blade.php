<svg class="bi bi-layout-text-sidebar-reverse {{ $class ?? null }}" width="{{ $width ?? '1em' }}" height="{{ $height ?? '1em' }}" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
